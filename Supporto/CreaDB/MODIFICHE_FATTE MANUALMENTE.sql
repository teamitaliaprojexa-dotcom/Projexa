...
ALTER TABLE tasks RENAME COLUMN title TO titile;



 ALTER TABLE proj_anno_fatt
ADD CONSTRAINT fk_proj_anno_fatt_project_id
FOREIGN KEY (project_id)
REFERENCES projectS(id);


ALTER TABLE proj_anno_fatt DROP CONSTRAINT fk_proj_anno_fatt_project_id;



ALTER TABLE projects ALTER COLUMN valore3 TYPE NUMERIC(12,2);
ALTER TABLE settings ALTER COLUMN valore3 TYPE NUMERIC(12,2);
ALTER TABLE clients ALTER COLUMN valore3 TYPE NUMERIC(12,2);

ALTER TABLE proj_worker_cost ADD COLUMN IF NOT EXISTS cod_billing VARCHAR(255);

ALTER TABLE proj_worker DROP CONSTRAINT fk_proj_worker_worker_cost;

projexa-auth
CREATE TABLE integr_tok_auth (
  id UUID PRIMARY KEY DEFAULT gen_random_uuid(),
  user_id UUID ,
  tipo_integrazione VARCHAR(255),
  provider_integrazione VARCHAR(255),
